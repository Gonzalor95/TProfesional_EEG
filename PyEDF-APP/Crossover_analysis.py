...
channels_crossoverCz = ['Cz', 'F3', 'P3', 'Pz', 'P4']
...
#signals_checkpoints = {"Cz_100uV": [44,51], "Cz_50uV": [82,88], "Cz_25uV": [122,128], "NotCz_100uV": [208,214], "NotCz_50uV": [254,261],}

#crossoverCz_signals = eeg_utils.generate_output_signal("Crossover_5Hz_Cz", channels_crossoverCz)
#signals_checkpoints = {"Cz_100": [26,32], "Cz_50": [50,56], "Cz_25": [81,87], "NotCz_100": [124,130],  "NotCz_50": [157,163],}

crossoverT7_signals = eeg_utils.generate_output_signal("Crossover_5Hz_T7", channels_crossoverT7)
signals_checkpoints = {"Cz_100": [29,35], "Cz_50": [54,60], "Cz_25": [86,91], "NotCz_100": [118,124],  "NotCz_50": [146,152],}
...
for key, time_checkpoint in signals_checkpoints.items():
    ...
    figure.suptitle(f"Crossover for {key}")
