...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selected_sim_time_value = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.selected_sim_time_value.sizePolicy().hasHeightForWidth())
        self.selected_sim_time_value.setSizePolicy(sizePolicy)
        self.selected_sim_time_value.setMinimumSize(QtCore.QSize(0, 0))
